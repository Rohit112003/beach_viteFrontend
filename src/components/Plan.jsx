  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4 ' >
        <div className='grid grid-cols-2 grid-rows-6 h-[80vh]'>
            ...
            <img className='row-span-3 object-cover w-full h-full p-2' src="https://images.unsplash.com/photo-1454391304352-2bf4678b1a7a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="" />
        ...
        <div className='flex flex-col h-full justify-center'>
            ...
            <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid, recusandae.</p>
            <div>
