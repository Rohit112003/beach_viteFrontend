...
const Navbar = () => {
  ...
  return (
    <div className='absolute w-full flex justify-between p-4 items-center'>
        ...
        <HiMenuAlt3 className='z-20 text-white  cursor-pointer fixed right-0' size={35} onClick={heandleNav} />
        <div className={nav?'ease-in duration-300 fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 px-4 py-7 flex-col z-10 ':'absolute top-0 h-screen left-[-100%] '} >
